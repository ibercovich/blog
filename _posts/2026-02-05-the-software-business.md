...
Furthermore, how many use cases that formerly relied on software can now be solved by an agent doing throwaway work? Do I need a personal financial planning tool, or do I just throw some data into Claude and ask for help? As I wrote in [Agents are a Generalized Technology](/2025/agents-are-a-generalized-technology):
